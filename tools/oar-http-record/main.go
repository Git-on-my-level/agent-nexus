...
import (
	...
	"organization-autorunner-tools-oar-http-record/internal/proxy"
	"organization-autorunner-tools-oar-http-record/internal/recorder"
)
...
func main() {
	...
	log.Printf("oar-http-record listening on http://%s and forwarding to %s", cfg.listenAddr, cfg.upstream)
