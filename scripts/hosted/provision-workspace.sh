...
HOST_ANX_WORKSPACE_ROOT=${WORKSPACE_ROOT}
ANX_CORE_PORT=${LISTEN_PORT}
ANX_WEB_UI_PORT=${WEB_UI_PORT}
ANX_WEB_UI_ORIGIN=${PUBLIC_ORIGIN}
ANX_CORE_BASE_URL=${PUBLIC_ORIGIN}
ANX_WEBAUTHN_RPID=${WEBAUTHN_RPID}
ANX_WEBAUTHN_ORIGIN=${PUBLIC_ORIGIN}
ANX_WEBAUTHN_ALLOWED_ORIGINS=${NORMALIZED_ALLOWED_ORIGINS}
ANX_WEBAUTHN_RP_DISPLAY_NAME="Agent Nexus"
ANX_CORS_ALLOWED_ORIGINS=
ANX_CORE_INSTANCE_ID=${CORE_INSTANCE_ID}
ANX_WORKSPACE_ID=${CORE_INSTANCE_ID}
ANX_WORKSPACE_NAME=${INSTANCE_NAME}
