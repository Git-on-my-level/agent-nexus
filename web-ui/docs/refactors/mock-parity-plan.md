...
The in-process **mock-core SvelteKit routes** are removed. Local development uses the **workspace proxy** to a real `oar-core` plus **dev fixture seeding** (`web-ui/scripts/seed-core-from-mock.mjs` and `web-ui/src/lib/devSeedData.js`).
