...
| Requirement                                                                             | Status | Implementation                                                                                                                                                                                    | Known limitations                                                                           | Tests                                                                                                                                        |
| --------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.1 Treat oar-core as source of truth                                                   | Met    | All reads/writes via `coreClient`/`oarCoreClient` (generated-command wrapper); optional server proxy in `src/hooks.server.js`; mock API handlers hard-fail when `OAR_CORE_BASE_URL` is configured | No offline cache invalidation strategy beyond fresh fetches                                 | `tests/e2e/integration-core-golden-path.spec.js`                                                                                             |
