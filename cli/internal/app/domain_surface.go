...
func agentDomainSurfaces() []domainSurface {
	return []domainSurface{
		...
		},
		{
			...
			ThreadBacked: true,
			Commands: []domainSurfaceCommand{
				{Path: "docs search", Target: "<q>", Examples: []string{"anx docs search \"runbook\""}, ForbidHelp: []string{}},
				{Path: "docs put", Target: "<path>", Examples: []string{"anx docs put runbook.md --title \"Runbook\" --tags knowledge"}, ForbidHelp: []string{}},
