...
func manualPreflightFlagSpecs() map[string]map[string]preflightFlagSpec {
	...
	return map[string]map[string]preflightFlagSpec{
		...
		"docs content":      {"document": valueFlag, "document-id": valueFlag},
		...
		"boards workspace":  {"board": valueFlag, "board-id": valueFlag},
		"boards cards list": {"board": valueFlag, "board-id": valueFlag},
		"auth list":         {},
		"auth default":      {},
		"config use":        {},
		"config unset":      {},
