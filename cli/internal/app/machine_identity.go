...
var machineCommandIdentityByPath = map[string]machineCommandIdentity{
	...
	"pm turns release":         {Command: "pm turns release", CommandID: "pm.turns.release"},
	...
	"docs search":          {Command: "docs search", CommandID: "docs.search"},
	"docs put":             {Command: "docs put", CommandID: "docs.put"},
	"docs ingest":          {Command: "docs ingest"},
	"docs get":             {Command: "docs get", CommandID: "docs.get"},
	"docs comment":         {Command: "docs comment", CommandID: "docs.comments.create"},
	"docs comments":        {Command: "docs comments", CommandID: "docs.comments.list"},
	"docs comments reply":  {Command: "docs comments reply", CommandID: "docs.comments.reply"},
	"docs comments edit":   {Command: "docs comments edit", CommandID: "docs.comments.update"},
	"docs comments delete": {Command: "docs comments delete", CommandID: "docs.comments.delete"},
